    ...
    Column {
        ...
        Column {
            ...
            Label {
                width: parent.width
                anchors.horizontalCenter: parent.horizontalCenter
                text: "<b>Translate</b> " + current_version
                fontSize: "large"
            ...
            Label {
                width: parent.width
                text: i18n.tr("Translate Application")
                horizontalAlignment: Text.AlignHCenter
        ...
        Label {
            text: i18n.tr("Source code available on %1").arg("<a href=\"https://github.com/turanmahmudov/Translate\">Github</a>")
            width: parent.width
            wrapMode: Text.WordWrap
            horizontalAlignment: Text.AlignHCenter
            linkColor: UbuntuColors.blue
